...
public class ConnectionUtil {
	...
	// add your jdbc url
	public static final String URL = "jdbc:postgresql://database-1.ckdonqvjc7hf.us-east-2.rds.amazonaws.com:5432/database_revature720";
	// add your jdbc username
	public static final String USERNAME = "dan39radke";
	// add your jdbc password
	public static final String PASSWORD = "51ldLU3gSw2c";
